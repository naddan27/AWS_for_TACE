...
def make_model_using_params_dict(params_dict, train_mode=True):
    ...
    operations_dictionary = {'CustomBlock': CustomBlock, 'ConvOperation': ConvOperation, 'ConvTransposeOperation': ConvTransposeOperation, 'PoolOperation': PoolOperation, 'UpsamplingOperation': UpsamplingOperation, 'NormalizationOperation': NormalizationOperation, 'ActivationOperation': ActivationOperation, 'ShortcutPooling': ShortcutPooling, 'GlobalAveragePoolOperation': GlobalAveragePoolOperation, 'GlobalMaxPoolOperation': GlobalMaxPoolOperation, 'DenseOperation': DenseOperation, 'RegularizationTerm': RegularizationTerm}
    #inputs of model
...
def dropblock(x, dropblock_params, params_dict, current_prob=None):

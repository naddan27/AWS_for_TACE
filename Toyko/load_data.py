    ...
    def generate_patches(self, patients_list_batch):
        ...
        for counter, patient in enumerate(patients_list_batch):
            ...
            if self.cache_volumes == True:
                ...
                if self.run_augmentations_every_epoch[0] == True or (self.epoch % self.run_augmentations_every_epoch[1]) == 0 or len(self.augmented_data_cache[patient]) == 0:
            ...
            if self.run_augmentations_every_epoch[0] == False and ((self.epoch % self.run_augmentations_every_epoch[1]) == 0 or len(self.augmented_data_cache[patient]) == 0):

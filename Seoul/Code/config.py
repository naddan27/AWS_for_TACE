...
trainModel = True   #set to false if you want to predict on the train/val/test set using this config file
params_dict = {}
...
#project directory
params_dict['scratch_dir'] = '/home/Data/TACE/tumor_seg/preop/percentage_in_liver_80_subtraction_before_norm/'
params_dict["job_id"] =  "earlyT1_earlydelayed_subtract_before_norm1"
...
params_dict['num_patches_per_patient'] = [2, 2]                         #number of patches to extract from each patient in the training set and validation set
...
params_dict['patch_size'] = [224, 224, 32]
...
params_dict['step_epoch_nums'] = [50, 85, 125, 170]                       #epochs at which learning rate decay will occur (make sure to take into account learning rate warmup if using that)
